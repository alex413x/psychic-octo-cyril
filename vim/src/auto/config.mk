...
PYTHON_GETPATH_CFLAGS = -DPYTHONPATH='":/usr/local/lib/python2.7/dist-packages/pip-1.0-py2.7.egg:/usr/lib/python2.7:/usr/lib/python2.7/plat-linux2:/usr/lib/python2.7/lib-tk:/usr/lib/python2.7/lib-old:/usr/lib/python2.7/lib-dynload:/usr/local/lib/python2.7/dist-packages:/usr/lib/python2.7/dist-packages"' -DPREFIX='"/usr"' -DEXEC_PREFIX='"/usr"'
