...
XS(XS_VIM_Buffers)
{
    ...
    SP -= items;
    {
#line 1014 "if_perl.xs"
    buf_T *vimbuf;
    int i, b;

#line 1160 "if_perl.c"
#line 1018 "if_perl.xs"
    if (items == 0)
    {
	if (GIMME == G_SCALAR)
	{
...
XS(XS_VIM_Windows)
{
    ...
    SP -= items;
    {
#line 1065 "if_perl.xs"
    win_T   *vimwin;
    int	    i, w;

#line 1227 "if_perl.c"
#line 1069 "if_perl.xs"
    if (items == 0)
    {
	if (GIMME == G_SCALAR)
